  ...
  programs.aerospace =
    ...
    in
    {
      ...
      userSettings = {
        ...
        after-startup-command = [ "exec-and-forget ${sketchybarPath} --reload" ];
        ...
        exec-on-workspace-change = [
          ...
          "-c"
          ''
            ${sketchybarPath} --trigger aerospace_workspace_change FOCUSED_WORKSPACE=$AEROSPACE_FOCUSED_WORKSPACE
          ''
        ];
